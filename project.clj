(defproject stockcache2 "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "stockcache2.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main stockcache2.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "stockcache2.core/on-figwheel-reload"}

                :compiler {:main stockcache2.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/stockcache2.js"
